...
function Ponderacion({ darkMode, client }) {
  if (!client)
    return (
      ...
      >
        <p>Selecciona un cliente para ver la ponderación</p>
      </div>
    );
...
export default function MessagesView({ darkMode }) {
  const [clients] = useState([
    { id: 1, name: "Jose Reyna", status: "Malo" },
    { id: 2, name: "Aldo Avalos", status: "Regular" },
    { id: 3, name: "Raul Reyna", status: "Excelente" },
  ]);
    ...
    <div
      style={{
        ...
        gridTemplateColumns: isMobile
          ...
          ? "2fr 3fr 2fr"
          : "1fr 3fr 2fr",
        height: "95%", // asegura que el grid ocupe toda la altura
      }}
    >
      {/* Clientes */}
      {(!isMobile || !selectedClient) && (
        ...
        >
          <h3 style={{ color: darkMode ? "#fff" : "#1a1a1a", fontSize: isMobile ? "16px" : "18px" }}>
            Clientes
          </h3>
          {clients.map((client) => (
            <div
      ...
      {selectedClient && (
        <div
          style={{
            ...
            flexDirection: "column",
            justifyContent: "flex-start",
            padding: "0px", // <- quitar padding del contenedor para evitar doble fondo
            borderRadius: "8px",
            height: "95%",
            overflowY: "auto", // scroll independiente
          }}
          ...
          {isMobile && (
            <div
              style={{
                ...
                color: darkMode ? "#fff" : "#333",
                marginBottom: "10px",
                padding: "0 15px", // opcional para alinear con el contenido del chat
              }}
