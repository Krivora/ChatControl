  ...
  const schema = yup.object({
    ...
    role_id: yup
    .mixed()
    .test("is-valid", "Selecciona un rol válido", (value) =>
      ["1", "2", "3", 1, 2, 3].includes(value)
    )
  ...
  export default function UserFormDialog({
   ...
   useEffect(() => {
    if (initialData && Object.keys(initialData).length > 0) {
      ...
      // 👇 Aseguramos valor seguro
      const role_id =
        initialData.role_id !== undefined && initialData.role_id !== null
          ? String(initialData.role_id) // convierte a string
          : "";
      ...
      reset({
        ...
        genero: "",
        fecha_nacimiento: "",
        role_id: "", // 👈 valor vacío por defecto
        password: "",
      });
    }
  }, [initialData, reset]);
